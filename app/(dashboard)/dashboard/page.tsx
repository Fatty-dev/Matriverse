  ...
  return (
    <>
      ...
      <main className="flex-1 px-8 sm:px-10 lg:px-12 py-8 overflow-y-auto bg-gradient-to-br from-slate-50/50 to-brand-surface/30">
        ...
        {isNewUser && (
          <Card className="mb-8 bg-gradient-to-r from-brand-mid to-brand-accent border-0 shadow-xl overflow-hidden">
            <CardContent className="p-8">
              <div className="flex items-center justify-between">
                <div className="text-white">
                  <h2 className="text-2xl font-bold mb-2">Welcome to MatriVerse, {firstName}!</h2>
                  <p className="opacity-90 mb-4">Your personalized pregnancy journey starts here. We&apos;re here to help you prepare for your special day.</p>
                  <div className="flex gap-4">
                    <Link href="/dashboard/scans" className="px-4 py-2 bg-white text-brand-mid rounded-lg font-medium hover:bg-white/90 transition-colors">
                      Upload Your First Scan
                    </Link>
                    <Link href="/dashboard/videos" className="px-4 py-2 bg-white/20 text-white rounded-lg font-medium hover:bg-white/30 transition-colors">
                      Explore Videos
                    </Link>
                  </div>
                </div>
        ...
        {daysToDue > 0 && (
          <Card className="mb-8 bg-gradient-to-br from-brand-dark via-brand-mid to-brand-accent border-0 shadow-xl overflow-hidden">
            <CardContent className="p-8">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white/80 text-sm font-medium mb-1">YOUR D-DAY COUNTDOWN</p>
                  <div className="flex items-baseline gap-3">
                    <span className="text-6xl font-bold text-white">{daysToDue}</span>
                    <span className="text-xl text-white/80">days to go</span>
                  </div>
        ...
        {/* Quick Mood Check-in */}
        {!hasMoodToday && (
          <Card className="mb-8 bg-white/90 backdrop-blur-sm border-0 shadow-lg shadow-brand-dark/5">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="text-4xl">&#128522;</div>
                  <div>
                    <h3 className="font-semibold text-text">How are you feeling today?</h3>
                    <p className="text-sm text-text-muted">Take a moment to check in with yourself</p>
                  </div>
                </div>
                <Link
                  href="/dashboard/mood"
                  className="px-4 py-2 bg-brand-mid text-white rounded-lg font-medium hover:bg-brand-dark transition-colors"
                >
                  Log Mood
                </Link>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg shadow-brand-dark/5">
            <CardContent className="p-6">
              <p className="text-sm font-medium text-text-muted mb-1">Days to D-Day</p>
              <div className="flex items-baseline gap-2">
